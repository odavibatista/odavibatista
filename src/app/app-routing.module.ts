...
import { SingleProjectComponent } from './components/pages/projects/single-project/single-project.component';
...
const routes: Routes = [
  ...
  },
  {
    path: 'projects',
    loadChildren: () =>
      import('./components/pages/projects/projects.module').then(
        (m) => m.ProjectsModule,
      ),
    data: { animation: fader },
  },
  { path: 'project', component: SingleProjectComponent },
  {
    path: 'talk+to+me',
    loadChildren: () =>
      import('./components/pages/talk-to-me/talk-to-me.module').then(
        (m) => m.TalkToMeModule,
      ),
    data: { animation: fader },
  },
