...
export class ExperiencesComponent {
  readonly Roles = [
    ...
    },
    {
      ...
      description:
        'Desenvolvimentos de sistema sob medida para empresas, ministração de aulas de programação, lógica e teoria da computação para estudantes de ensino fundamental e médio, auxílio e mentoria para estudantes de graduação e pós-graduação com apoio prestado projetos acadêmicos com notas de 8.5-10.0.',
    },
    {
      ...
      description:
        'Planejamento, arquitetura e engenharia de sistemas, desenvolvimento back-end e front-end, documentação de projetos, desenvolvimento de testes unitários, desenvolvimento do escopo de aplicações.',
    },
    {
