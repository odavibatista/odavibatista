  ...
  @Output() studies = [
    {
      ...
      title:
        'Superior em Ciência da Computação pela Universidade São Judas Tadeu',
      conclusion: 2027,
      description:
        'Faço o curso de Ciência da Computação, aonde aprendo sobre paradigmas dos sistemas de informação, e aprendo linguagens de programação úteis para a ciência de dados. O curso também ensina o desenvolvimento mobile, através de Java e Kotlin.',
    },
    {
      ...
      conclusion: 2024,
      description:
        'Realização de Hackathons e desafios de desenvolvimento, ficando em terceiro lugar no Segundo Hackathon, e em segundo lugar no Primeiro Challenge OneBitCode. Especializações realizadas em Angular, NextJs, Tailwind e Jest.',
    },
    {
