  ...
  readonly Projects: Project[] = [
    {
      ...
      briefing:
        'Landing Page desenvolvida para a Agência Colaborativa de Design Synko.',
    ...
    },
    {
      ...
      briefing:
        'Aplicação full-stack para controle de pedidos e comandas de usuários de um restaurante italiano, colocado em 2º Lugar no primeiro Challenge OneBitCode',
...

    {
      ...
      title: 'Wits!',
      briefing:
        'App full-stack desenvolvido para a sexta edição do Hackathon OneBitCode, simulando um app de aprendizado gamificado para lógica, aritmética e raciocínio.',
...

    {
      ...
      title: 'xHealth Gyms',
      briefing:
        'SPA colaborativa desenvolvida em Angular 16 para o segundo hackathon da OneBitCode, colocado em terceiro lugar no ranking dos melhores projetos.',
...

    {
      ...
      briefing:
        'E-commerce construído através de React, Vite e Bootstrap, com funções de cadastro, carrinho de compras, e finalização de compras com endereço e recibo, com layout e wireframe próprios.',
...

    {
      ...
      title: "Dev's Den",
      briefing:
        'App full-stack simulando um site de empregos para profissionais de T.I. e Programação, desenvolvido para as disciplinas de Usabilidade e Desenvolvimento Web + Sistemas Distribuídos.',
      deployUrl: '',
...

    {
      ...
      title: 'MyBookshelf',
      briefing:
        'Aplicativo Desktop construído em Java, para a criação de um acervo virtual que contém informações sobre livros, além de avaliações e controle de qualidade deles.',
      deployUrl: '',
...

    {
      ...
      title: 'Vivi Bot',
      briefing:
        'Projeto de bot de Discord open-source, feito com NodeJs e TypeScript pela biblioteca DiscordJS. Possui funções nativas para as jogadas de dados, e a aplicação pode ser clonada.',
...

    {
      ...
      briefing:
        'Projeto em construção através de NuxtJS, TailWindCSS e MongoDB, para simular uma linha de açougues nacional de alta qualidade e preço acessível.',
...

    {
      ...
      briefing:
        'Projeto de um site de receitas, feito com a API Spoonacular e construído via Angular 16. Neste projeto, uso das opções de renderização e componentização do Angular para treinar o framework e o uso de APIs.',
...

    {
      ...
      briefing:
        'Aplicativo de rolagem de dados para sistemas Exalted/VTM, com taxas de sucesso e impressão dos resultados e seus tipos na interface do usuário, feito com SCSS e JavaScript.',
...

    {
      ...
      title: 'Dev Portfolio',
      briefing:
        'Single Page Application produzida com Angular 16, Bootstrap e SCSS, com wireframe desenhado no Figma para a criação e estilização do projeto e suas funcionalidades.',
      deployUrl: '',
    ...
    },
    {
      ...
      briefing:
        'Conjunto de aplicações desenvolvidas para representar conceitos de Teoria da Computação através da simulação de autômatos finitos determinísticos.',
    ...
    },
    {
      ...
      briefing:
        'Bot para Discord capaz de consultar versículos da Vulgata Latina em tempo real através de Slash Commands.',
      deployUrl: '',
...

    {
      ...
      title: 'Vivace Hotels',
      briefing:
        'Landing Page institucional desenvolvida para fins de estudo em UI/UX Design e desenvolvimento front-end, simulando a presença digital da rede fictícia de pousadas Vivace Hotels.',
      deployUrl: '',
...

    {
      ...
      briefing:
        'Boilerplate backend para aplicações NestJS contendo autenticação JWT, criptografia com Bcrypt, TypeORM, Swagger, Docker, Seeds, Cache e validações com Zod e Class Validator.',
      deployUrl: '',
...

    {
      ...
      title: 'WeCryptIt',
      briefing:
        'Aplicação web voltada para criptografia e proteção de informações, desenvolvida para demonstrar conceitos de segurança da informação, criptografia e experiência do usuário.',
...

    {
      ...
      title: 'Core Notes',
      briefing:
        'Aplicação full-stack de gerenciamento de notas para treino de utilização de Cache, Arquitetura DDD e outros conceitos avançados de back-end.',
      deployUrl: '',
